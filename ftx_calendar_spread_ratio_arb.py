...
plt.plot(df_merge["best_price_BTC-1231"] - df_merge["best_price_BTC-PERP"])
plt.plot(df_merge["best_price_BTC-0924"] - df_merge["best_price_BTC-PERP"])
plt.show()

plt.plot(df_merge["best_price_BTC-PERP"])
...
plt.plot(df_merge["1231_PERP_basis_ratio"])
...
plt.plot(df_merge["0924_PERP_basis_ratio"])
...
plt.plot(df_merge["1231_0924_basis_ratio"])
...
df_merge["lending_rate_0924"] = df_merge["ts"].apply(lambda x : 0.025*(ts_dict["0924"] - x)/(60*60*24*365))
df_merge["lending_rate_1231"] = df_merge["ts"].apply(lambda x : 0.025*(ts_dict["1231"] - x)/(60*60*24*365))

plt.plot(df_merge["0924_PERP_basis_ratio"])
plt.plot(df_merge["lending_rate_0924"])
plt.show()

plt.plot(df_merge["1231_PERP_basis_ratio"])
plt.plot(df_merge["lending_rate_1231"])
plt.show()
